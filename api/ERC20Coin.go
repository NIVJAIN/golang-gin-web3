...
func (_Api *ApiCaller) Count(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Api.contract.Call(opts, &out, "count")
...
//
// Solidity: function count() view returns(uint256)
func (_Api *ApiSession) Count() (*big.Int, error) {
	return _Api.Contract.Count(&_Api.CallOpts)
}

// Count is a free data retrieval call binding the contract method 0x06661abd.
//
// Solidity: function count() view returns(uint256)
func (_Api *ApiCallerSession) Count() (*big.Int, error) {
	return _Api.Contract.Count(&_Api.CallOpts)
}
...
func (_Api *ApiCaller) GetText(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Api.contract.Call(opts, &out, "getText")
...
//
// Solidity: function getText() view returns(string)
func (_Api *ApiSession) GetText() (string, error) {
	return _Api.Contract.GetText(&_Api.CallOpts)
}

// GetText is a free data retrieval call binding the contract method 0xe00fe2eb.
//
// Solidity: function getText() view returns(string)
func (_Api *ApiCallerSession) GetText() (string, error) {
	return _Api.Contract.GetText(&_Api.CallOpts)
}
...
// SetMessage is a free data retrieval call binding the contract method 0xe90847f4.
//
// Solidity: function setMessage() view returns(string)
func (_Api *ApiCaller) SetMessage(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Api.contract.Call(opts, &out, "setMessage")
...
//
// Solidity: function setMessage() view returns(string)
func (_Api *ApiSession) SetMessage() (string, error) {
	return _Api.Contract.SetMessage(&_Api.CallOpts)
}

// SetMessage is a free data retrieval call binding the contract method 0xe90847f4.
//
// Solidity: function setMessage() view returns(string)
func (_Api *ApiCallerSession) SetMessage() (string, error) {
	return _Api.Contract.SetMessage(&_Api.CallOpts)
}
...
func (_Api *ApiTransactor) Decrement(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Api.contract.Transact(opts, "decrement")
}

// Decrement is a paid mutator transaction binding the contract method 0x2baeceb7.
//
// Solidity: function decrement() returns()
func (_Api *ApiSession) Decrement() (*types.Transaction, error) {
	return _Api.Contract.Decrement(&_Api.TransactOpts)
}

// Decrement is a paid mutator transaction binding the contract method 0x2baeceb7.
//
// Solidity: function decrement() returns()
func (_Api *ApiTransactorSession) Decrement() (*types.Transaction, error) {
	return _Api.Contract.Decrement(&_Api.TransactOpts)
}
...
func (_Api *ApiTransactor) Increment(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Api.contract.Transact(opts, "increment")
}

// Increment is a paid mutator transaction binding the contract method 0xd09de08a.
//
// Solidity: function increment() returns()
func (_Api *ApiSession) Increment() (*types.Transaction, error) {
	return _Api.Contract.Increment(&_Api.TransactOpts)
}

// Increment is a paid mutator transaction binding the contract method 0xd09de08a.
//
// Solidity: function increment() returns()
func (_Api *ApiTransactorSession) Increment() (*types.Transaction, error) {
	return _Api.Contract.Increment(&_Api.TransactOpts)
}

// SetText is a paid mutator transaction binding the contract method 0x5d3a1f9d.
//
// Solidity: function setText(string _setText) returns()
func (_Api *ApiTransactor) SetText(opts *bind.TransactOpts, _setText string) (*types.Transaction, error) {
	return _Api.contract.Transact(opts, "setText", _setText)
}

// SetText is a paid mutator transaction binding the contract method 0x5d3a1f9d.
//
// Solidity: function setText(string _setText) returns()
func (_Api *ApiSession) SetText(_setText string) (*types.Transaction, error) {
	return _Api.Contract.SetText(&_Api.TransactOpts, _setText)
}

// SetText is a paid mutator transaction binding the contract method 0x5d3a1f9d.
//
// Solidity: function setText(string _setText) returns()
func (_Api *ApiTransactorSession) SetText(_setText string) (*types.Transaction, error) {
	return _Api.Contract.SetText(&_Api.TransactOpts, _setText)
}
