...
// Routes for user
func (usr BlockchainRouter) Routes(conn *api.Api, client *ethclient.Client, router *gin.Engine) {
	bc := bcc.SetUserController(conn, client)
	...
	user.GET("/counter/increment", bc.CounterIncrement)
